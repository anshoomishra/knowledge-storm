...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'note.context_processor.global_categories',
            ],
        },
    },
]
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://redis-server:6379/1',  # Redis server URL
        'OPTIONS': {
...
# Optional: Set the default timeout for cache items (e.g., 5 minutes)
CACHE_TIMEOUT = 1500